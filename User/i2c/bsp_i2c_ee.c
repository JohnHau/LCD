...
uint8_t rotate_array_asc16(uint8_t*in,uint8_t*out)
{
	uint8_t i=0;
	uint8_t rv[8]={0};
...
uint8_t test_asc16[16]={0x00,0x00,0x7e,0x7e,0x5a,0x18,0x18,0x18,0x18,0x18,0x18,0x3c,0x00,0x00,0x00,0x00};
//uint8_t test_asc16[16]={0x00,0x00,0xc6,0xc6,0x6c,0x7c,0x38,0x38,0x7c,0x6c,0xc6,0xc6,0x00,0x00,0x00,0x00};


uint8_t up[8]  ={0x0c,0x3c,0xf0,0xe0,0xf0,0x3c,0x0c,0x00};
uint8_t down[8]={0x0c,0x0f,0x03,0x01,0x03,0x0f,0x0c,0x00};


uint8_t asc16[128][16]=
{
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  ...
  //for(y=0;y<8;y++)
    {
			...
			while(*str)
			{
				...
				rotate_array_asc16(asc16[*str],out);
	  ...
	  ee_WriteBytes(write_buf, 0x00, 1);
				...
				i=0;
				rotate_array_asc16(asc16[*str] + 8,out);
